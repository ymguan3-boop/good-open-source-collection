...
async function Module(t = {}) {
	...
	function x() {
		return e.locateFile ? (t = "lerc-wasm.wasm", e.locateFile ? e.locateFile(t, u) : u + t) : new URL("/good-open-source-collection/GeoLibre-Web/assets/lerc-wasm-CcWaYBBN.wasm", "" + import.meta.url).href;
		var t;
	}
	async function B(t) {
		if (!f) try {
