...
// can reuse it; re-exported here so existing call sites keep one import path.
export { assignTableNames, previewLayerTables, type SqlWorkspaceTable } from "./sql-table-names";
