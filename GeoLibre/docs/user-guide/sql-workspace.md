...
![The SQL Workspace docked below the map, with a query on the left and its result table on the right](https://assets.geolibre.app/images/geolibre-sql-workspace.webp)
